...
void Libav::Init()
{
    ...
    PixelDescriptionMap[PIX_FMT_YUV420P] = wxT("8bit YUV420");
    PixelDescriptionMap[PIX_FMT_YUYV422] = wxT("8bit YUYV422");
    PixelDescriptionMap[PIX_FMT_RGB24] = wxT("8bit RGB24");
    PixelDescriptionMap[PIX_FMT_BGR24] = wxT("8bit BGR24");
    PixelDescriptionMap[PIX_FMT_YUV422P] = wxT("8bit YUV422");
    PixelDescriptionMap[PIX_FMT_YUV444P] = wxT("8bit YUV444");
    PixelDescriptionMap[PIX_FMT_YUV410P] = wxT("8bit YUV410");
    PixelDescriptionMap[PIX_FMT_YUV411P] = wxT("8bit YUV411");
    PixelDescriptionMap[PIX_FMT_GRAY8] = wxT("8bit GRAY8");
    PixelDescriptionMap[PIX_FMT_MONOWHITE] = wxT("1bit MONOWHITE");
    PixelDescriptionMap[PIX_FMT_MONOBLACK] = wxT("1bit MONOBLACK");
    PixelDescriptionMap[PIX_FMT_PAL8] = wxT("8bit PAL8");
    PixelDescriptionMap[PIX_FMT_YUVJ420P] = wxT("8bit YUVJ420");
    PixelDescriptionMap[PIX_FMT_YUVJ422P] = wxT("8bit YUVJ422");
    PixelDescriptionMap[PIX_FMT_YUVJ444P] = wxT("8bit YUVJ444");
    PixelDescriptionMap[PIX_FMT_XVMC_MPEG2_MC] = wxT("XVMC-MC");
    PixelDescriptionMap[PIX_FMT_XVMC_MPEG2_IDCT] = wxT("XVMC-IDCT");
    PixelDescriptionMap[PIX_FMT_UYVY422] = wxT("8bit UYVY422");
    PixelDescriptionMap[PIX_FMT_UYYVYY411] = wxT("8bit UYVY411");
    PixelDescriptionMap[PIX_FMT_BGR8] = wxT("2.6bit BGR8");
    PixelDescriptionMap[PIX_FMT_BGR4] = wxT("1.3bit BGR4");
    PixelDescriptionMap[PIX_FMT_BGR4_BYTE] = wxT("2.6bit BGR4BYTE");
    PixelDescriptionMap[PIX_FMT_RGB8] = wxT("2.6bit RGB8");
    PixelDescriptionMap[PIX_FMT_RGB4] = wxT("1.3bit RGB4");
    PixelDescriptionMap[PIX_FMT_RGB4_BYTE] = wxT("2.6bit RGB4BYTE");
    PixelDescriptionMap[PIX_FMT_NV12] = wxT("8bit NV12420");
    PixelDescriptionMap[PIX_FMT_NV21] = wxT("8bit NV21420");
    PixelDescriptionMap[PIX_FMT_ARGB] = wxT("8bit ARGB");
    PixelDescriptionMap[PIX_FMT_RGBA] = wxT("8bit RGBA");
    PixelDescriptionMap[PIX_FMT_ABGR] = wxT("8bit ABGR");
    PixelDescriptionMap[PIX_FMT_BGRA] = wxT("8bit BGRA");
    PixelDescriptionMap[PIX_FMT_GRAY16BE] = wxT("16bit GRAY16BE");
    PixelDescriptionMap[PIX_FMT_GRAY16LE] = wxT("16bit GRAY16LE");
    PixelDescriptionMap[PIX_FMT_YUV440P] = wxT("8bit YUV440");
    PixelDescriptionMap[PIX_FMT_YUVJ440P] = wxT("8bit YUVJ440");
    PixelDescriptionMap[PIX_FMT_YUVA420P] = wxT("8bit YUVA420");
    PixelDescriptionMap[PIX_FMT_VDPAU_H264] = wxT("VDPAU-H264");
    PixelDescriptionMap[PIX_FMT_VDPAU_MPEG1] = wxT("VDPAU-MPEG1");
    PixelDescriptionMap[PIX_FMT_VDPAU_MPEG2] = wxT("VDPAU-MPEG2");
    PixelDescriptionMap[PIX_FMT_VDPAU_WMV3] = wxT("VDPAU-WMV3");
    PixelDescriptionMap[PIX_FMT_VDPAU_VC1] = wxT("VDPAU-VC1");
    PixelDescriptionMap[PIX_FMT_RGB48BE] = wxT("16bit RGB48BE");
    PixelDescriptionMap[PIX_FMT_RGB48LE] = wxT("16bit RGB48LE");
    PixelDescriptionMap[PIX_FMT_RGB565BE] = wxT("5.3bit RGB565BE");
    PixelDescriptionMap[PIX_FMT_RGB565LE] = wxT("5.3bit RGB565LE");
    PixelDescriptionMap[PIX_FMT_RGB555BE] = wxT("5.3bit RGB555BE");
    PixelDescriptionMap[PIX_FMT_RGB555LE] = wxT("5.3bit RGB555LE");
    PixelDescriptionMap[PIX_FMT_BGR565BE] = wxT("5.3bit BGR565BE");
    PixelDescriptionMap[PIX_FMT_BGR565LE] = wxT("5.3bit BGR565LE");
    PixelDescriptionMap[PIX_FMT_BGR555BE] = wxT("5.3bit BGR555BE");
    PixelDescriptionMap[PIX_FMT_BGR555LE] = wxT("5.3bit BGR555LE");
    PixelDescriptionMap[PIX_FMT_VAAPI_MOCO] = wxT("VAAPI-MOCO");
    PixelDescriptionMap[PIX_FMT_VAAPI_IDCT] = wxT("AAPI-IDCT");
    PixelDescriptionMap[PIX_FMT_VAAPI_VLD] = wxT("VAAPI-VLD");
    PixelDescriptionMap[PIX_FMT_YUV420P16LE] = wxT("16bit YUV420LE");
    PixelDescriptionMap[PIX_FMT_YUV420P16BE] = wxT("16bit YUV420BE");
    PixelDescriptionMap[PIX_FMT_YUV422P16LE] = wxT("16bit YUV422LE");
    PixelDescriptionMap[PIX_FMT_YUV422P16BE] = wxT("16bit YUV422BE");
    PixelDescriptionMap[PIX_FMT_YUV444P16LE] = wxT("16bit YUV444LE");
    PixelDescriptionMap[PIX_FMT_YUV444P16BE] = wxT("16bit YUV444BE");
    PixelDescriptionMap[PIX_FMT_VDPAU_MPEG4] = wxT("VDPAU-MPEG4");
    PixelDescriptionMap[PIX_FMT_DXVA2_VLD] = wxT("DXVA2-VLD");
    PixelDescriptionMap[PIX_FMT_RGB444LE] = wxT("5.3bit RGB444LE");
    PixelDescriptionMap[PIX_FMT_RGB444BE] = wxT("5.3bit RGB444BE");
    PixelDescriptionMap[PIX_FMT_BGR444LE] = wxT("5.3bit BGR444LE");
    PixelDescriptionMap[PIX_FMT_BGR444BE] = wxT("5.3bit BGR444BE");
    PixelDescriptionMap[PIX_FMT_Y400A] = wxT("8bit Y400A");
    PixelDescriptionMap[PIX_FMT_BGR48BE] = wxT("16bit BGR48BE");
    PixelDescriptionMap[PIX_FMT_BGR48LE] = wxT("16bit BGR48LE");
    PixelDescriptionMap[PIX_FMT_YUV420P9BE] = wxT("9bit YUV420BE");
    PixelDescriptionMap[PIX_FMT_YUV420P9LE] = wxT("9bit YUV420LE");
    PixelDescriptionMap[PIX_FMT_YUV420P10BE] = wxT("10bit YUV420BE");
    PixelDescriptionMap[PIX_FMT_YUV420P10LE] = wxT("10bit YUV420LE");
    PixelDescriptionMap[PIX_FMT_YUV422P10BE] = wxT("10bit YUV422BE");
    PixelDescriptionMap[PIX_FMT_YUV422P10LE] = wxT("10bit YUV422LE");
    PixelDescriptionMap[PIX_FMT_YUV444P9BE] = wxT("9bit YUV444BE");
    PixelDescriptionMap[PIX_FMT_YUV444P9LE] = wxT("9bit YUV444LE");
    PixelDescriptionMap[PIX_FMT_YUV444P10BE] = wxT("10bit YUV444BE");
    PixelDescriptionMap[PIX_FMT_YUV444P10LE] = wxT("10bit YUV444LE");
    PixelDescriptionMap[PIX_FMT_YUV422P9BE] = wxT("9bit YUV422BE");
    PixelDescriptionMap[PIX_FMT_YUV422P9LE] = wxT("9bit YUV422LE");
    PixelDescriptionMap[PIX_FMT_VDA_VLD] = wxT("?bit VDA VLD");
    PixelDescriptionMap[PIX_FMT_GBRP] = wxT("8bit GBR444");
    PixelDescriptionMap[PIX_FMT_GBRP9BE] = wxT("9bit GBR444BE");
    PixelDescriptionMap[PIX_FMT_GBRP9LE] = wxT("9bit GBR444LE");
    PixelDescriptionMap[PIX_FMT_GBRP10BE] = wxT("10bit GBR444BE");
    PixelDescriptionMap[PIX_FMT_GBRP10LE] = wxT("10bit GBR444LE");
    PixelDescriptionMap[PIX_FMT_GBRP16BE] = wxT("16bit GBR444BE");
